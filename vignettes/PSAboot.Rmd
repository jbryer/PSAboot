...
#### Project website: [github.com/jbryer/PSAboot](https://github.com/jbryer/PSAboot)
...
R Core Team (2013). R: A language and environment for statistical computing. R Foundation for Statistical Computing, Vienna, Austria. URL https://r-project.org.
